...
if (isset($infos)) {
    ...
    if ($logo!='') {
        $return.='<span><img src="'.$logo.'" alt="'.$title.'" title="'.$title.'"/>';
    }
    if ($name!='') {
        $return.='<span class="icon-folder">&nbsp;</span>'.$name;
    }
    if ($url!='') {
    ...
    if ($person!='') {
        $return.='<span class="icon-ok">&nbsp;</span>'.$person;
    }
    if ($email!='') {
        $return.='<span class="glyphicon icon-envelope">&nbsp;</span>'.JHTML::link('mailto:'.$email.'?subject='.$_SERVER["HTTP_HOST"], $email);
    }
    if ($skype!='') {
        $return.='<span class="glyphicon icon-chevron-right">&nbsp;Skype :</span>'.JHTML::link('skype:'.$skype.'?chat', $skype);
    }
    if ($phone!='') {
        $return.='<span class="glyphicon icon-phone">&nbsp;</span>'.$phone;
    }
    if ($country!='') {
        $return.='<span class="icon-featured">&nbsp;</span>'.$country;
    }
} // if (isset($infos))
