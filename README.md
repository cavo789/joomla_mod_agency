...
mod_agency is a module for the Joomla backend and will display information about the web agency who's responsible for the site. Name, URL, phone number, email, skype, ... of the person in charge of the daily maintenance of the site. mod_agency has been developed by the [JUG Wallonie](http://www.jugwallonie.be).
